...
{
	this(TypeDef[] typeDefs, GlobalVar[] globalVars,
		Native[] natives, Function[] functions)
	{
...
class Function : ISyntaxTree
{
	this(bool isConstant, FunctionDecl header
		, LocalVar[] locals, Statement[] statements)
	{
		this.isConstant = isConstant;
		this.header = header;
		this.locals = locals;
...
{
	this(Expression condition, Statement[] thenClause, ElseClause[] elseClauses, bool isDebug = false)
	{
		super(isDebug);
	...
	private
	{
		...
		ElseClause[] elseClauses;
	}
}

class LoopStatement : Statement
{
	this(Statement[] statements, bool isDebug = false)
	{
		super(isDebug);
		this.statements = statements;
	}
